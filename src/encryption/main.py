...
if __name__ == '__main__':
    ...
    if json_object["method"] == "rot13":
        ...
        json_object["cipher_text"] = cipher_methods.vigenere_cipher(json_object["clear_text"], key)
    elif json_object["method"] == "vigenere_clear":
        key = cipher_methods.generateKey(json_object["clear_text"], json_object["key"])
        json_object["cipher_text"] = cipher_methods.vigenere_decode(json_object["clear_text"], key)
